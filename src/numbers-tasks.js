 ...
 *   1678, 3  => 2000
 */
function roundToPowerOfTen(val, power) {
  return 10 ** power * Math.round(val / 10 ** power);
}
 ...
 *   10 => 55
 */
function getFibonacciNumber(inx) {
  function helper(iterationsLeft, a, b) {
    if (iterationsLeft === 0) {
      return a;
    }

    return helper(iterationsLeft - 1, b, a + b);
  }

  return helper(inx, 0, 1);
}
